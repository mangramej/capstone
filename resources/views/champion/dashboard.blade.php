                    ...
                    <div class="rounded-lg border border-gray-100 bg-white p-6 shadow">
                        ...
                        <div class="mt-2 bg-gray-100 rounded p-1">
                            <table class="min-w-full divide-y-2 divide-gray-200 text-sm">
                                <thead>
                                    <tr>
                                        <td colspan="2" class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                            Breakdown
                                        </td>
                                        <td class="text-end whitespace-nowrap px-4 py-2 font-medium text-gray-900">Status
                                        </td>
                                    </tr>
                                </thead>
