                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm border rounded">
                        ...
                        <tr>
                            ...
                            <td colspan="2"
                                class="w-full whitespace-nowrap px-4 py-2 text-gray-700 font-medium">{{ $milk_bag->provider->fullname() }}</td>
                        </tr>

                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700 bg-gray-100">Total Bags Available</td>
                            <td colspan="2"
                                class="w-full whitespace-nowrap px-4 py-2 text-gray-700 font-medium">{{ $milk_bag->total_milk_bags }}</td>
                        </tr>
