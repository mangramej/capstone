...
{{--                <livewire:profile.update-account-information :user="$user" />--}}
                ...
                <form method="POST" action="{{ route('admin.users.update', [$user]) }}" class="p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <x-bz.text-input id="password" name="password" type="password" class="mt-1 block w-full" autocomplete="new-password" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-bz.text-input id="password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full" autocomplete="new-password" />
